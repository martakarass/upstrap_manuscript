...
out_GLMM <- matrixStats::colMeans2(mat_out_GLMM)
out_GEE <- matrixStats::colMeans2(mat_out_GEE)
...
# define results dir
out_dir_raw <- paste0(here::here(), "/numerical_experiments/results_CL/2021-02-15-lmm_trt_raw")
