...
#' 
#' CIs are constructed in 5 different ways.
#' 
#' Note loops are used on purpose (instead of matrices for all repetition) to 
#' avoid running out of memory on cluster nodes. 
#' 
#' @author 
