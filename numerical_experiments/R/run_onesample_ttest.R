...
#' Rnosave run_onesample_ttest.R -N JOB_onesample_ttest
...
res_fdir_agg  <- paste0(here::here(), "/numerical_experiments/results_CL_shared/2021-07-07-onesample_ttest_agg")
