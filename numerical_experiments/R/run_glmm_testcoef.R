...
#' rm JOB_onesample*
#' 
#' rm $ups/numerical_experiments/results_CL/2021-08-07-glmm_testcoef_raw/*
...
# dir to save results 
res_fdir_raw  <- paste0(here::here(), "/numerical_experiments/results_CL/2021-08-07-glmm_testcoef_raw")
...
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
# RUN SIMULATIONS TO BE RUN ONCE
