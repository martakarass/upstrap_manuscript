...
res_fdir_agg  <- paste0(here::here(), "/numerical_experiments/results_CL_shared/2021-05-25-onesample_ttest_compare_upstrap_powerttest_agg")
...
for (i in 1 : length(fnames_all_1)){ # i <- 1
  message(paste0("i: ", i))
...
saveRDS(out_agg_df, paste0(res_fdir_agg, "/onesample_ttest_compare_upstrap_powerttest_bootCI.rds"))
rm(out_agg_df)
