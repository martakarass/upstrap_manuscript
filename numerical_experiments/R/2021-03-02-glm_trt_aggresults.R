...
#' This script aggregates the estimates of power of rejecting H0 in glm
#' regression problem.
#' 
#' Notes: 
#' cd $ups 
#' cd numerical_experiments/R
#' Rnosave 2021-03-02-glm_trt_aggresults.R -N JB_glm_trt_agg
...
# dir to data saves
res_fdir_raw  <- paste0(here::here(), "/numerical_experiments/results_CL/2021-03-01-glm_trt_raw")
res_fdir_agg  <- paste0(here::here(), "/numerical_experiments/results_CL_shared/2021-03-01-glm_trt_agg")
dir.create(path = res_fdir_agg)

# experiment parameters (relevant subset; see /R/2021-02-17-glm_trt.R)
...
# save the aggregated data 
saveRDS(out_df_all, paste0(res_fdir_agg, "/glm_trt_samplesize_est_bootCI.rds"))
rm(out_df_all)
