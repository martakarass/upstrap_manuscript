...
#' rm $ups/numerical_experiments/results_CL/2021-12-03-lmm_testcoef_vary_nobs_sd_2_raw/*
#' Rnosave run_lmm_testcoef_vary_nobs_sd_2.R -t 1-1000 -tc 75 -N JOB_lmm_testcoef_vary_nobs_sd_2
#' 
#' ls -l -d *JOB_lmm_testcoef_vary_nobs_sd_2*
#' rm JOB_lmm_testcoef_vary_nobs_sd_2*
...
# dir to save results 
res_fdir_raw  <- paste0(here::here(), "/numerical_experiments/results_CL/2021-12-03-lmm_testcoef_vary_nobs_sd_2_raw")
...
ni      <- 30  # number of observations per subject 
coef_x0 <- 0 
coef_x1 <- 0.5
coef_x2 <- 1
coef_x3 <- -1
