...
out_power_df_fpath <- paste0(here::here(), "/use_case_examples/bausema2016/results/2021-05-01-upstrap_no_agg_results.rds")
...
for (i in 1 : length(name_levels)){ # i <- 1
  ...
  plt_i <- 
    ...
    geom_hline(yintercept = 0.8, color = "blue", alpha = 0.6, linetype = 2)
  plt_i
...
plt_path <- paste0(here::here(), "/use_case_examples/bausema2016/results_figures/2021-05-01-upstrap_no_agg_results.png")
